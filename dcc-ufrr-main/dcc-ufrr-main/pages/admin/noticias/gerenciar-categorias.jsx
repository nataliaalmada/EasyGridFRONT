...
export default function GerenciarCategorias() {
  ...
  async function handleCadastrar(dataForm) {
    createCatNoticias(dataForm.name)
      .then((data) => {
        if (data) {
          handleOnCloseModal();
          toast({
              ...
              <Table size="sm" whiteSpace="break-spaces">
                <Thead>
                  <Tr>
                    ...
                    <Th>ID</Th>
                    <Th>Nome</Th>
                    <Th textAlign="center">Notícias/Eventos</Th>
                      ...
                      .map((cat) => {
                        return (
                          <Tr key={cat.id}>
                            ...
                            <Td>{cat.id}</Td>
                            <Td>{cat.name}</Td>
                            <Td textAlign="center">{cat.noticias?.length}</Td>
                            <Td textAlign="center">
