...
export default function GerenciarPaginas() {
  ...
  function handleAtualizarPage(pag) {
    setSelectedPageCtx(pag);
    setCreateFlagCtx(false);
    router.push("/admin/pag-institucionais/atualizar-pagina");
  }
        ...
        <HStack w="full" justifyContent="space-between">
          ...
          <Button
            ...
            onClick={() => {
              ...
              router.push("/admin/pag-institucionais/criar-pagina");
            }}
          >
            Adicionar uma nova
          </Button>
              ...
              <Table size="sm" whiteSpace="break-spaces">
                <Thead>
                  <Tr>
                    ...
                    <Th>Página</Th>
                    <Th>Título</Th>
                    <Th textAlign="center">Categoria (Menu)</Th>
                ...
                <Tbody>
                  {data &&
                    data.map((cat) => {
                      return cat.PageInstitucionals.sort(
                        ...
                        return (
                          <Tr key={pag.id}>
                            ...
                            <Td textAlign="center">{pag.User?.name}</Td>
                            <Td>{new Date(pag.createdAt).toLocaleString()}</Td>
                            <Td textAlign="center">
                              {pag.active ? (
                                <Button
                                  colorScheme="green"
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>
              Tem certeza que deseja apagar a página:{" "}
