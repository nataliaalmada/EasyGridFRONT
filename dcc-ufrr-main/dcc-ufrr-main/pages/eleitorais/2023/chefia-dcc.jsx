                  ...
                  <Tbody fontSize="sm">
                    <Tr>
                      <Td whiteSpace="pre-wrap">
                        <Link
                          href="https://arquivos.ufrr.br/index.php/s/1foS2K1UWYd8wAn"
                          isExternal
                        >
                          <HStack>
                            <Icon as={AiOutlineFilePdf} color="red.600" />
                            <Text>
                              EDITAL No. 01/2023 - ELEIÇÃO CHEFIA - DCC/CCT/UFRR
                              - ABERTURA
                            </Text>
                          </HStack>
                        </Link>
                    ...
                    <Tr>
                      <Td whiteSpace="pre-wrap">
                        <Link
                          href="https://arquivos.ufrr.br/index.php/s/CDIC5vDXI8BSuiu"
                          isExternal
                        >
                          <HStack>
                            <Icon as={AiOutlineFilePdf} color="red.600" />
                    ...
                    <Tr>
                      <Td whiteSpace="pre-wrap">
                        <Link
                          href="https://arquivos.ufrr.br/index.php/s/e3hYMHA4BWQh9WV"
                          isExternal
                        >
                          <HStack>
                            <Icon as={AiOutlineFilePdf} color="red.600" />
                            <Text>Resultado das Eleições - Chefia DCC</Text>
                          </HStack>
                        </Link>
                      </Td>
